...
local config = {
  ...
  on_attach = require("user.lsp.handlers").on_attach_java,
  ...
  runtimes = {
    ...
    {
      name = "JavaSE-17",
      path = "/Library/Java/JavaVirtualMachines/jdk-18.0.1.jdk/Contents/Home/",
    },
  },
  ...
  init_options = {
    bundles = {
      ...
      -- vim.fn.glob("~/.config/java/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar")
      vim.fn.glob("~/.config/java/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.36.0.jar")
    },
    -- bundles = bundles,
  },
}
